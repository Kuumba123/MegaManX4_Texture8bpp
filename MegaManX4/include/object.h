...
typedef struct {
    ...
    int x;
    int y;
    enemyStruct * enemyP; /* for enemy spawner & other things */
    ...
    int accelX;
    int accelY;
    animeFrameStruct * animeTableP;
    byte * frameP;
    byte * texP;
    byte * sprtDataP;
    ushort texCord;
    ushort clutCord;
    animeFrameStruct animeInfo;
    byte newAnimeF;
